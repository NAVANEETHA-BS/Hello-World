...
#11)python program to accept a hyphen separated sequence of words as input and print the words in a Hyphen-separated sequence after sorting them alphabetically
eg"
